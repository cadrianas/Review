...
#sch = SemanticScholar()
#data = []
#results = sch.search_paper('covid 19 modeling', fields_of_study=["Mathematics"])

#for item in results:
     #data.append(item['openAccessPdf'])
 #    data.append(item)
 #    print(item['openAccessPdf'])
#print(len(results))
...
fields = "title,year,citationCount,authors,openAccessPdf,abstract"
