...
# Function to analyze with Ollama
...
def analyze_url_content(ollama_client, url):
    try:
        ...
        contribution = analyze_with_ollama(ollama_client, contrib_prompt)

        limit_prompt = f"What are the limitations of the methodology used in this article?\n\n{content}"
        limitations = analyze_with_ollama(ollama_client, limit_prompt)
    ...
    with open(output_csv, 'w', newline='') as csvfile:
        ...
        for index, row in data.iterrows():
            ...
            if url:
                ...
                url_sir_score = (sir_score * 0.3) + (summarization_score * 0.7)
            else:
                contribution = "N/A"
                limitations = "N/A"
                url_sir_score = 0
...
if __name__ == "__main__":
    input_csv = "outputs/combined_outputs_ollama.csv"
