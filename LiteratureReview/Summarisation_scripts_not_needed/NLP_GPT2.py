...
abstractive_model = GPT2LMHeadModel.from_pretrained("gpt2")
abstractive_tokenizer = GPT2Tokenizer.from_pretrained("gpt2")
...
data.to_csv('pegasus_summary.csv', index=False)
print("Summaries saved to 'pegasus_summary.csv'.")